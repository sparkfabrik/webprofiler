...
/**
 * Functional tests for the WebProfiler module.
 *
 * @group webprofiler
 */
class WebprofilerFunctionalTest extends BrowserTestBase {
  ...
  public function testUninstallation() {
    // Go to uninstallation page an uninstall WebProfiler:
    $session = $this->assertSession();
    $page = $this->getSession()->getPage();
    $this->drupalGet('/admin/modules/uninstall');
    $session->statusCodeEquals(200);
    $page->checkField('edit-uninstall-webprofiler');
